...
(define -set make-Set)
(define -Mutable-vec make-Mutable-Vector)
(define -Immutable-vec make-Immutable-Vector)
(define (make-Vector a) (Un (-Mutable-vec a) (-Immutable-vec a)))
(define -vec make-Vector)
(define (make-HeterogeneousVector ts) (Un (make-Immutable-HeterogeneousVector ts)
                                          (make-Mutable-HeterogeneousVector ts)))
(define (-Immutable-vec* . ts) (make-Immutable-HeterogeneousVector ts))
(define (-Mutable-vec* . ts) (make-Mutable-HeterogeneousVector ts))
