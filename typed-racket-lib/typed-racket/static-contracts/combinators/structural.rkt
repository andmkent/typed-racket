...
(combinator-structs
  ...
  ((immutable-vector/sc . (#:covariant)) immutable-vector/c #:chaperone) ;; Not flat because vector/c is not flat (unless `#:flat? #t`, but then elements must all be flat)
